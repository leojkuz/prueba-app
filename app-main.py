...
https://www.minsalud.gov.co/Paginas/Minsalud-cuenta-con-estrategia-para-prevenir-anemia-en-primera-infancia-.aspx
    ...
    **La anemia en niños disminuyó en 7,6 puntos porcentuales**
    ...
    if viz_menu == "Situación Global":
        ...
        # Indicadores (Méritos)
        col1, col2, col3 = st.columns([1, 0.65, 1.35])
        ...
        fig_yes.update_layout(
            title=dict(text='Anemia en consumidores de hierro', x=0.25, font=dict(size=16)),
            showlegend=False
        )
        ...
        fig_no.update_layout(
            title=dict(text='Anemia en no consumidores de hierro', x=0.25, font=dict(size=16)),
            showlegend=False
        )
